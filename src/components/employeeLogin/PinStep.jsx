...
const PinStep = ({ employee, pinInput, setPinInput, loading, error, handlePinSubmit, goBack }) => {
  const emp = employee
  return (
    <div className="space-y-5">
      <div className="text-center">
        <h2 className="text-lg font-semibold text-slate-900">{emp?.full_name}</h2>
        <p className="text-slate-500 text-sm mt-1">{formatPhone(emp?.phone)}</p>
      </div>
